...
def start_screen():
    ...
    screen.blit(fon, (0, 0))
    c = pygame.font.Font(None, 30)
    b = 50
    for line in intro_text:
        d = c.render(line, 1, pygame.Color('white'))
        intro_rect = d.get_rect()
        b += 10
        intro_rect.top = b
        intro_rect.x = 10
        b += intro_rect.height
        screen.blit(d, intro_rect)
...
if __name__ == '__main__':
    level = load_level(input("Зайдите в каталог 'data' и выберите файл с нужной картой. Введите имя файла с картой: "))
